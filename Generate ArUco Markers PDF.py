...
def create_aruco_pdf(output_file, marker_size_mm=30, page_size=(210, 297)):
    """Create a PDF with ArUco markers."""
    ...
    markers_per_column = int(page_size[1] / (marker_size_mm + 5))  # 5mm gap
    ...
    for i in range(markers_per_row * markers_per_column):
        ...
        y = page_size[1]*mm - (row + 1) * (marker_size_mm + 5) * mm
...
# Generate the PDF
create_aruco_pdf('aruco_markers.pdf')
print("ArUco markers PDF has been generated.")